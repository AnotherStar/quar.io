...
Техническое правило JSON: из-за строгой схемы каждый объект block содержит все поля. Для неиспользуемых полей ставь пустые значения: level=0, text="", items=[], taskItems=[], rows=[], hasHeaderRow=false, severity="", description="", url="", codeLanguage="", links=[].
