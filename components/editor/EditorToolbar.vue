...
function togglePopover(name: 'table' | 'safety' | 'headings' | 'sections' | 'modules') {
  const wasOpen
...
<template>
  <div ref="toolbarRef" class="editor-toolbar-bar sticky top-[24px] z-10 flex flex-wrap items-center gap-2">
    ...
    <div class="toolbar-group">
      <UiTooltip text="Жирный (⌘B)"><button type="button" :class="btnClass(isActive('bold'))" @click="editor.chain().focus().toggleBold().run()"><Icon name="lucide:bold" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Курсив (⌘I)"><button type="button" :class="btnClass(isActive('italic'))" @click="editor.chain().focus().toggleItalic().run()"><Icon name="lucide:italic" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Зачёркнутый"><button type="button" :class="btnClass(isActive('strike'))" @click="editor.chain().focus().toggleStrike().run()"><Icon name="lucide:strikethrough" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Inline код"><button type="button" :class="btnClass(isActive('code'))" @click="editor.chain().focus().toggleCode().run()"><Icon name="lucide:code" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Ссылка"><button type="button" :class="btnClass(isActive('link'))" @click="setLink"><Icon name="lucide:link" class="h-4 w-4" /></button></UiTooltip>
    </div>

    <!-- Группа 3: списки и блоки текста -->
    <div class="toolbar-group">
      <UiTooltip text="Маркированный список"><button type="button" :class="btnClass(isActive('bulletList'))" @click="editor.chain().focus().toggleBulletList().run()"><Icon name="lucide:list" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Нумерованный список"><button type="button" :class="btnClass(isActive('orderedList'))" @click="editor.chain().focus().toggleOrderedList().run()"><Icon name="lucide:list-ordered" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Чек-лист"><button type="button" :class="btnClass(isActive('taskList'))" @click="editor.chain().focus().toggleTaskList().run()"><Icon name="lucide:list-checks" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Цитата"><button type="button" :class="btnClass(isActive('blockquote'))" @click="editor.chain().focus().toggleBlockquote().run()"><Icon name="lucide:quote" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Блок кода"><button type="button" :class="btnClass(isActive('codeBlock'))" @click="editor.chain().focus().toggleCodeBlock().run()"><Icon name="lucide:square-code" class="h-4 w-4" /></button></UiTooltip>
    </div>

    <!-- Группа 4: выравнивание -->
    <div class="toolbar-group">
      <UiTooltip text="По левому краю"><button type="button" :class="btnClass(isActive({ textAlign: 'left' }))" @click="editor.chain().focus().setTextAlign('left').run()"><Icon name="lucide:align-left" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="По центру"><button type="button" :class="btnClass(isActive({ textAlign: 'center' }))" @click="editor.chain().focus().setTextAlign('center').run()"><Icon name="lucide:align-center" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="По правому краю"><button type="button" :class="btnClass(isActive({ textAlign: 'right' }))" @click="editor.chain().focus().setTextAlign('right').run()"><Icon name="lucide:align-right" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="По ширине"><button type="button" :class="btnClass(isActive({ textAlign: 'justify' }))" @click="editor.chain().focus().setTextAlign('justify').run()"><Icon name="lucide:align-justify" class="h-4 w-4" /></button></UiTooltip>
    </div>
    ...
    <div class="relative">
      <UiTooltip text="Таблица" :disabled="showTable">
        <button type="button" :class="btnClass(isActive('table'))" @click="togglePopover('table')">
    ...
    <!-- Группа 6: история -->
    <div class="toolbar-group">
      <UiTooltip text="Отменить (⌘Z)"><button type="button" :class="btnClass(false)" @click="editor.chain().focus().undo().run()"><Icon name="lucide:undo-2" class="h-4 w-4" /></button></UiTooltip>
      <UiTooltip text="Повторить (⌘⇧Z)"><button type="button" :class="btnClass(false)" @click="editor.chain().focus().redo().run()"><Icon name="lucide:redo-2" class="h-4 w-4" /></button></UiTooltip>
    </div>
  </div>
</template>
