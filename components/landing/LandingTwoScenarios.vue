...
const scenarios = [
  {
    ...
    body: 'Wildberries, Ozon, Яндекс Маркет — после покупки клиент может не разобраться с настройкой и вернуть товар или оставить плохой отзыв, а вы платите за это 30-50% комиссии с каждого заказа.',
    solution: 'quar.io: Клиент попадает напрямую к вам. Вы помогаете разобраться с настройкой и улучшаете рейтинг карточки.',
...
const iconTone = {
  primary: 'bg-tint-sky text-primary',
  warning: 'bg-tint-peach text-warning'
}
</script>
    ...
    <div class="container-page pb-hero pt-section md:pt-section-lg">
      ...
      <div class="mt-xl grid gap-2xl md:mt-section md:grid-cols-2">
        <article
          ...
          :key="scenario.title"
          class="flex flex-col rounded-2xl bg-surface p-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_28px_-6px_rgba(70,55,40,0.18)]"
        >
          <div class="flex items-center gap-md">
            <div :class="['grid h-12 w-12 shrink-0 place-items-center rounded-full', iconTone[scenario.tone]]">
