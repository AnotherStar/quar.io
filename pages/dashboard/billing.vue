  ...
  <div class="space-y-xl">
    ...
    <UiCard v-if="data?.trial?.isTrialing" tint="yellow" :bordered="false">
      ...
      <ul class="mt-2 space-y-1 text-body-sm text-charcoal">
        ...
        <li class="text-charcoal/70">⚠️ Лимит инструкций — 3 (как на Free), чтобы по окончании триала ничего не пропало</li>
      </ul>
      <p class="mt-md text-caption text-charcoal/70">
        После окончания триала вы вернётесь на Free. Кастомные секции и модули останутся в БД,
        но перестанут отображаться на публичных страницах. Сами инструкции продолжат работать.
      </p>
    </UiCard>

    <UiCard v-else-if="!trialBlocked">
      <h3 class="text-h4">Попробовать Plus 30 дней бесплатно</h3>
