    ...
    <div class="mt-sm flex flex-wrap items-center justify-between gap-md">
      ...
      <div class="relative w-full max-w-sm">
        ...
        <input
          ...
          class="h-10 w-full rounded-md border border-transparent bg-surface px-md pl-9 text-body-sm-md placeholder:text-hairline-strong outline-none focus:border-primary focus:bg-canvas focus:ring-2 focus:ring-primary/20"
        >
      </div>
    </div>
