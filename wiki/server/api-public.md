...
Модуль `api-public` содержит публичные Nitro API routes для просмотра опубликованных инструкций, отправки пользовательской аналитики и сбора обратной связи по блокам инструкции. Он обслуживает публичный viewer quar.io и не содержит логики авторизации в показанном коде.
