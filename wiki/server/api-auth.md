...
Модуль `api-auth` реализует Nitro API routes для аутентификации пользователей в ManualOnline. Он отвечает за регистрацию, вход, выход и получение текущего пользователя с привязками к tenant-организациям и тарифным планам.
...
Регистрация создаёт не только пользователя, но и минимальную организационную структуру для работы в ManualOnline:
