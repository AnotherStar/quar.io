...
Модуль `api-instructions` реализует Nitro API routes для управления инструкциями в quar.io: создание, редактирование, публикация, архивирование, версии, аналитика, feedback, подключение reusable sections и pluggable modules. Также модуль содержит серверные сценарии генерации инструкций из PDF/изображений через OpenAI, включая потоковую генерацию с SSE.
...
Модуль использует несколько серверных утилит quar.io:
