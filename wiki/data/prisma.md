...
Модуль `prisma` описывает модель данных quar.io и базовые seed-данные для запуска SaaS-платформы. Он определяет PostgreSQL-схему для пользователей, tenants, инструкций, версионирования, модулей, аналитики, медиа и подписок, а также заполняет справочники тарифов и доступных модулей.
...
Эта часть схемы реализует расширяемую plugin-систему quar.io.
...
### Внутренние доменные зависимости quar.io
