...
Модуль `page-dashboard` содержит страницы приватного кабинета продавца quar.io, расположенные в `pages/dashboard`. Он отвечает за управление инструкциями, публикацию, аналитику, переиспользуемые секции, подключаемые модули, биллинг, настройки аккаунта и служебные разделы дашборда.
