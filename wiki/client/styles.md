...
Модуль `styles` задаёт глобальные стили и дизайн-токены фронтенда ManualOnline. Он обеспечивает единый визуальный язык для публичных страниц инструкций, редактора TipTap и интерфейсных элементов, используя Tailwind CSS и CSS Custom Properties.
...
Файл содержит дизайн-токены ManualOnline в виде CSS Custom Properties, объявленных в `:root`.
