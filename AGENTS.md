# AGENTS.md — инструкции для ИИ-агентов в репозитории ManualOnline

Этот файл — единая точка входа для любого ИИ-ассистента, работающего с ManualOnline: Codex, Claude Code, Cursor, Aider и т.п.
Симлинки `CLAUDE.md` и `.cursorrules` указывают сюда, чтобы правила были одни на всех.

---

## 1. Что такое ManualOnline

ManualOnline — Nuxt 3 fullstack SaaS для размещения, редактирования и аналитики интерактивных инструкций к товарам. Покупатель сканирует QR на упаковке и попадает на публичную инструкцию, а продавец управляет инструкциями, секциями, модулями, публикациями и аналитикой из дашборда.
